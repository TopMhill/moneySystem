...
<%
    ...
    if(point == null || address == null || purchases == null ||point.equals("")||address.equals("")||purchases.equals("")){
%>
<h1 class="title">修改失败，请输入完整信息！</h1>
<%}
else{
%>
...
<%
    ...
    String Sql = "update purchase_order set commissioned_employee_id = " + u.getId() + ", customer_point_of_contact = '" + point + "', customer_billing_address = '" + address + "', products_purchases = '" + purchases + "', date = '" + cdate + "', money = '" + money + "' where id = " + oid + ";";
