...
public class DateInfo {
    ...
    {
    	if(date==null&&calendar==null&&dayOfWeek==null)
    	{
    		return "暂无日期";
    	}
    	String ans="";
    ...
    public int caldays(DateInfo to)
    {
    	int ans=0;
    	DateInfo nowday= new DateInfo(this.getString());
    	while(!nowday.getformatstr().equals(to.getformatstr()))
    	{
    		nowday=nowday.calculatePreviousDate(-1);
    		ans=ans+1;
    	}
    	return ans;
    }
    public String getlikeaday()
    {
    	String ans=getstr(8);
    	for(int i=0;i<6;i++)
    	{
